...
export async function formatPaymentSuccess(
  ...
  try {
    ...
    console.error(`Error formatting payment success notification for ID ${paymentId}:`, error);
    throw error;
  }
}
...
export async function formatPaymentRefund(
  ...
  try {
    ...
    console.error(`Error formatting payment refund notification for ID ${paymentId}:`, error);
    throw error;
  }
}
