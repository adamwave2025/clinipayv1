...
const PaymentPageClinicCard = ({
  ...
  // Validate amounts for debugging purposes
  if (paymentPlan) {
    validatePenceAmount(planTotalAmount, 'ClinicCard-planTotalAmount');
    validatePenceAmount(totalPaid, 'ClinicCard-totalPaid');
    validatePenceAmount(totalOutstanding, 'ClinicCard-totalOutstanding');
  }
  validatePenceAmount(clinic.amount, 'ClinicCard-amount');
